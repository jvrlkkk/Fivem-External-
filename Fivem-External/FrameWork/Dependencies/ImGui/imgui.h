...
struct ImVec2
{
    ...
    float DistTo(const ImVec2& vec) const
    {
        ImVec2 Delta;
...
namespace ImGui
{
    ...
    IMGUI_API bool          CustomChild(const char* str_id, const ImVec2& size = ImVec2(0, 0));
    ...
    IMGUI_API bool          BeginTooltip(std::string name = "", bool value = false);                                                   // begin/append a tooltip window.
